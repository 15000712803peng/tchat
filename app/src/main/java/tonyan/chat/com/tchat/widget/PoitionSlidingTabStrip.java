...
public class PoitionSlidingTabStrip extends HorizontalScrollView {
	...
	public void attchViewPager(ViewPager pager){
		this.pager = pager;
	...
	private OnPageChangeListener delegatePageListener = new OnPageChangeListener() {
		@Override
	...
	public PoitionSlidingTabStrip(Context context) {
		this(context, null);
	}

	public PoitionSlidingTabStrip(Context context, AttributeSet attrs) {
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawRect(lineLeft +interval , height - indicatorHeight, lineRight-interval, height,
				rectPaint);
