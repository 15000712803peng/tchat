...
public class RefreshLayout extends LinearLayout {
    ...
    private void initRefreshHeaderView() {
        ...
        if (mRefreshHeaderView != null) {
            ...
            Drawable colorDrawable = mRefreshHeaderView.getBackground();
            if(colorDrawable instanceof ColorDrawable){
                ColorDrawable color = (ColorDrawable) colorDrawable;
                mWholeHeaderView.setBackgroundColor(color.getColor());
            }
